...
function initStaticCache(rootDir) {
  const files = [
    ...
    { name: 'auth-ui.js', type: 'application/javascript' },
    { name: 'app.js', type: 'application/javascript' },
    { name: 'dashboard-ui.js', type: 'application/javascript' },
    { name: 'sessions-ui.js', type: 'application/javascript' },
    { name: 'misc-ui.js', type: 'application/javascript' },
    { name: 'system-ui.js', type: 'application/javascript' },
    { name: 'memory-ui.js', type: 'application/javascript' },
    { name: 'bootstrap.js', type: 'application/javascript' }
  ];
