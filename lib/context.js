...
const WORKSPACE_DIR = path.resolve(process.env.WORKSPACE_DIR || process.env.OPENCLAW_WORKSPACE || DEFAULT_WORKSPACE_DIR);
const WORKSPACE_SOURCE = process.env.WORKSPACE_DIR ? 'WORKSPACE_DIR' : process.env.OPENCLAW_WORKSPACE ? 'OPENCLAW_WORKSPACE' : 'default';
